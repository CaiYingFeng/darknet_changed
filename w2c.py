#评估轨迹使用，经过hfent里jupyter处理后，再经过此处处理即可得到c2w可输入rpg_trajectory_evaluation中评估
#用于转换相机到世界和世界到相机
import numpy as np
...
i_path=Path('/media/autolab/disk_3T/caiyingfeng/rpg_trajectory_evaluation/front_center_hfnet',f'stamped_traj_estimate.txt')#要保存的c2w:time tx ty tz qx qy qz qw 
